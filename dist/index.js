...
let consulta2 = criarConsulta(2, medico3, paciente2, new Date(2026, 3, 1, 8, 0, 0), 900);
consulta2 = confirmarConsulta(consulta2);
console.log("=== CONSULTA CONFIRMADA ===");
console.log(exibirConsulta(consulta2));
let consulta3 = criarConsulta(3, medico3, paciente3, new Date(2026, 3, 1, 9, 0, 0), 900);
consulta3 = confirmarConsulta(consulta3);
console.log("=== CONSULTA CONFIRMADA ===");
console.log(exibirConsulta(consulta3));
const cancelada = cancelarConsulta(consulta2);
if (cancelada) {
    console.log("=== CONSULTA CANCELADA ===");
    console.log(exibirConsulta(cancelada));
}
let consulta4 = criarConsulta(4, medico3, paciente1, new Date(2026, 3, 1, 8, 0, 0), 900);
consulta4 = confirmarConsulta(consulta4);
console.log("=== CONSULTA CONFIRMADA ===");
console.log(exibirConsulta(consulta4));
export {};
